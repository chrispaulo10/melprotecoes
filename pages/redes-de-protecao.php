        ...
        <div class="row">
          <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="text-center mb-5">
                <p>
                    <span id="zona"></span>
                    A rede de proteção é um acessório útil para garantir total segurança.
                    <div class="collapse" id="collapseExample">
                         
Essas telas de proteção são geralmente feitas em polietileno, que é um material de altíssima resistência. <br> <br>

Ele é muito difícil de estourar – o que o torna perfeito para segurança 
total das redes de proteção. As redes fabricadas com esse material são instaladas em sacadas e 
janelas de prédios, onde residem crianças, idosos e animais de estimação. Elas também podem revestir escadas, 
piscinas ou até mesmo coberturas. <br> <br>

Um dos aspectos mais positivos dessa 
rede é que não agride a estética do ambiente. A Rede de 
proteção é composta por malhas permitindo ar livre e a 
iluminação solar. Por isso, elas também são muito usadas em espaços de 
diversão como, quadras de esporte e playgrounds. As redes inspiram cuidado e proteção, 
garantindo mais liberdade para a brincadeira das crianças e mais tranquilidade aos pais. As telas são 
instaladas por medidas e podem se adaptar ao tamanho necessário 
para sua sacada. Assim, elas podem cobrir diferentes espaços – desde escadas até janelas. <br> <br>

Na hora da instalação, também é importante fixar os ganchos de forma correta. Eles são feitos de metal 
resistente e devem ser presos na parede a cada 35 centímetros. <br><br>

A Mel Proteções disponibiliza telas para proteção de diferentes espessuras, cores e 
tamanhos. As cores das telas mais escolhidas são brancas e pretas, pois os padrões dos condomínios 
exigem a mesma cor para não alterar a faixada do prédio e na maior parte das vezes optam pelas 
cores branca e preta. A rede em polietileno de fábrica tem a medida de 35 metros de comprimento e 7 metros na altura, 
muito uteis para cobrir partes extensas. Essas redes são recomendadas por muitas ONGS de crianças e 
gatos, inclusive a rede de proteção é um item obrigatório para poder adotar um gato. Aqui na 
Mel Proteções você encontra diversos modelos de redes, para atender diferentes necessidades. <br><br>

A tela com a malha 3, por exemplo, é ótima para impedir a entrada de pombos e morcegos em galpões, escolas e hospitais. Elas podem ser instaladas em todos os vãos onde o pássaro posso ter acesso, com malhas menores que os dos modelos de proteção para crianças ela elimina 100% a entrada de pássaros no ambiente. A Mel Proteções disponibiliza diferentes redes de Proteção, ótima para a segurança de toda família. Confira todos produtos aqui em nosso site!
</div>
                </p>
  ...
  <div class="container mt-5 pb-5">
    <h5>
      Por que devo instalar uma rede de proteção?
    </h5>
    <p class="text-justify">
      A rede de proteção é um dos principais itens de segurança que deve ser instalado para segurança de crianças, evitando quedas. Com as redes de proteção você pode proteger, janelas, sacadas, varandas, terraços, piscinas, decks e até vãos de escada. Este produto não serve só para a proteção para crianças, mas também para diminuir o risco de eventuais quedas com animais de estimação. No térreo a rede de proteção pode funcionar como uma proteção ante fuga para gatos, se você tem um espaço dedicado para seu pet essa é a melhor solução, evitando a saída para parte externa. Também pode ser usada para proteger espaços como terraços e decks, playgrounds ou até mesmo para um gatil. Além de todo esse potencial de proteção em diversos ambientes, uma das principais vantagens das redes é que elas têm as malhas, que formam uma barreira protetora sem atrapalhar a passagem da luz solar e a vista para fora do ambiente.
    </p>
    <h5>
      Qual a rede de proteção ideal para crianças?
    </h5>
    <p class="text-justify">
      Para instalação das redes de proteção, você deve verificar se a mesma contém todos os laudos técnicos conforme a norma NBR 16.046 estabelecida pela ABNT. Quanto às cores, você pode escolher entre a branca, preta, areia e marrom. As cores acabam dando opções discretas para cada ambiente por isso, funcionam bem em qualquer ambiente, seja na madeira ou até mesmo na alvenaria você pode optar pela cor que combine mais e mantêm a aparência intacta.
    </p>
    <h5>
      Como instalar redes de proteção?
    </h5>
    <p class="text-justify">
      Não faça você mesmo! Consulte sempre profissionais especializados para a instalação das redes de proteção. Esse mecanismo de segurança exige muitas técnicas para serem instaladas, caso a pessoa que venha instalar não aplicar as redes de proteção conforme as normas da ABNT, a segurança de todos estará vulnerável. Para começar, antes da contratação você precisa verificar se a empresa possui CNPJ atualizado, e é sempre bom fazer também uma pesquisa de mercado sobre a empresa no Google, Reclame – Aqui e Procon.  
    </p>
    <h5>
      Proteja as Crianças!
    </h5>
    <p class="text-justify">
      Para garantir total segurança para as crianças, vá além das redes. Proteja a descida das escadas com portões que só você conseguirá abrir, coloque travas em janelas basculantes. Cuidado com pisos escorregadios e coloque antiderrapante nos tapetes. Mantenha sempre uma mão segurando o bebê durante a troca de fraldas. Nunca deixe um bebê sozinho em mesas, camas ou outros móveis, mesmo que seja por pouco tempo.
    </p>
  </div>
