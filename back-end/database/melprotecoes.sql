...
--
-- Host: 127.0.0.1
-- Tempo de geração: 24-Mar-2021 às 16:39
...
ALTER TABLE `cidades` ADD CONSTRAINT `cidade_estado_fk` FOREIGN KEY (`id_estado_fk`) REFERENCES `estados`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;
